// frontend/lib/screens/site_search_screen.dart
...
class _SiteSearchScreenState extends State<SiteSearchScreen>
  ...
  Future<void> _searchSite(String name) async {
    ...
    setState(() { isLoading = true; _lastQuery = name.trim(); });
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: const Text("Heritage site not found."),
          ...
          Expanded(
            child: Theme(
              ...
              child: TextField(
                ...
                onSubmitted: (v) => _searchSite(v.trim()),
              ),
            ),
          ),
          GestureDetector(
            onTap: () => _searchSite(_searchController.text.trim()),
            child: Container(
              width: 34, height: 34,
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    ...
                    textAlign: TextAlign.center,
                    style: TextStyle(
                        fontSize: 13.5, color: _textSub, height: 1.6),
                  ),
                ],
              ),
            ),
        ...
        return _SiteCard(
          ...
          onRoute: () {
            if (UserLocationState.userLat == null ||
              ...
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: const Text("User location not available."),
                backgroundColor: const Color(0xFFC62828),
                behavior: SnackBarBehavior.floating,
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(10)),
...
class _SiteCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final hasAlert = site["disaster"]?["has_alert"] == true;
    final isHigh   = site["disaster"]?["risk_level"] == "High";
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(20),
        border: const Border(
            top: BorderSide(color: Color(0xFFFFD700), width: 2.5)),
        boxShadow: [
          BoxShadow(
          ...
          children: [
            ...
            if (site["place_name"] != null)
              Row(children: [
                const Icon(Icons.place_outlined,
                    size: 14, color: Color(0xFF90A4C4)),
                const SizedBox(width: 5),
                Expanded(
            ...
            Row(
              ...
              children: [
                ...
                if (site["safety_status"] != null) const SizedBox(width: 10),
                if (site["distance_km"] != null)
                  Expanded(
                    child: Padding(
                      padding: const EdgeInsets.only(top: 3),
                      child: Text(
                        "From you: ${site["distance_km"]} km",
                        style: const TextStyle(
                            fontSize: 12, color: Color(0xFF90A4C4)),
                      ),
                    ),
            ...
            if (events.isEmpty)
              Container(
                ...
                child: const Row(children: [
                  Icon(Icons.info_outline,
                      size: 15, color: Color(0xFF90A4C4)),
                  SizedBox(width: 8),
