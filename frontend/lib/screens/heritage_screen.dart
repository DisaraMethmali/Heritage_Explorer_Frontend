// frontend/lib/screens/heritage_screen.dart
...
class _HeritageScreenState extends State<HeritageScreen>
  ...
  // ── Unified Popup with Unity integration ───────────────────────────────────
              ...
              content: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                      ...
                      child: SwitchListTile(
                        title: const Text("GeoSync",
                            style: TextStyle(
                                ...
                                fontSize: 14)),
                        subtitle: const Text("Require physical presence at site",
                            style:
                    ...
                    // Manual GPS offset fields (only when both toggles are ON)
                    if (isBothTogglesOn) ...[
                              ...
                              decoration: InputDecoration(
                                ...
                                border: OutlineInputBorder(
                                  ...
                                  borderSide: BorderSide(
                                      color: _textSub.withValues(alpha: 0.3)),
                                ),
                    ...
                    // GeoSync only + not near site warning
                    if (geoSyncEnabled &&
                        !demoModeEnabled &&
                    ...
                    // Syncing indicator OR Start button
                    if (isSyncing)
                      const Column(
                        children: [
                          CircularProgressIndicator(color: _navyMid),
                          SizedBox(height: 10),
                          Text(
                        ...
                        onTap: canStartExperience
                            ? () async {
                                ...
                                try {
                                  ...
                                  } else if (geoSyncEnabled && demoModeEnabled) {
                                    latToSend =
              ...
              children: yearRanges.map((range) {
                ...
                return InkWell(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected
                          ? _navyMid.withValues(alpha: 0.07)
                          : Colors.transparent,
                      borderRadius: BorderRadius.circular(10),
                      border: isSelected
                          ? Border(
                              left: BorderSide(color: _navyMid, width: 3))
                          : null,
                    ),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        ...
                        if (isSelected)
                          Container(
                            width: 22, height: 22,
                            decoration: BoxDecoration(
                                shape: BoxShape.circle, color: _navyMid),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        // actions: [
        //   IconButton(
        //     icon: const Icon(Icons.description_outlined, color: _gold),
        ...
        bottom: PreferredSize(
          ...
          child: Container(
            ...
            decoration: const BoxDecoration(
              gradient:
                  LinearGradient(colors: [_gold, Color(0xFFFFA500), _gold]),
            ),
          ),
        ),
      ),
                      ...
                      child: Row(children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: _navyMid.withValues(alpha: 0.08),
                            border: Border.all(
                                color: _navyMid.withValues(alpha: 0.2)),
                          ),
                          child: const Icon(Icons.info_outline,
                              color: _navyMid, size: 18),
                        ),
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: CircularProgressIndicator(
                              color: _goldDeep, strokeWidth: 2.5),
                        ),
                      )
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          ...
                          const Text(
                            ...
                            style:
                                TextStyle(fontSize: 14, color: _textSub),
